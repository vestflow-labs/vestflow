...
interface NewStreamClientProps {
  /**
   * Receiver pre-filled by the profile "Fund this project" button (#812).
   * Delivered by the server page from the `beneficiary` query parameter.
   */
  initialBeneficiary?: string;
}

export default function NewStreamClient({ initialBeneficiary }: NewStreamClientProps) {
  ...
  return (
    <>
      ...
      <main className="max-w-2xl mx-auto px-6 pt-28 pb-20">
        ...
        {step === "form" && <CreateForm initialBeneficiary={initialBeneficiary} />}
        {step === "confirm" && (
